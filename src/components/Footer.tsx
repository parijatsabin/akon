      ...
      >
        ...
        <div style={{ flexShrink: 0, maxWidth: 290 }}>
          ...
          <div style={{ display: "flex", gap: 10 }}>
            <SocialBtn href={BRAND.socialLinks.instagram} label="Instagram">
              <IGIcon />
            </SocialBtn>
            <SocialBtn href={BRAND.socialLinks.facebook} label="Facebook">
              <FBIcon />
            </SocialBtn>
            <SocialBtn href={BRAND.socialLinks.pinterest} label="Pinterest">
              <PinterestIcon />
            </SocialBtn>
          </div>
        </div>
