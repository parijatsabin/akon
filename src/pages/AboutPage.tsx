                    ...
                    <div className="ab-commit" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 64, alignItems: "center" }}>
                        ...
                        <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
                            {COMMITMENT.pillars.map((p) => (
                                <div key={p.id} style={{ display: "flex", alignItems: "flex-start", gap: 18, padding: "20px 22px", background: "var(--warm-white)", borderRadius: "var(--radius)", border: "1px solid var(--border)" }}>
                        ...
                        <div>
                            ...
                            <Link to="/products" className="btn btn-dark">Explore Our Fragrances</Link>
                        </div>
                    </div>
                </div>
            </section>
