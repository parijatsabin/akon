                    ...
                    <div className="ct-grid">
                        ...
                        <div style={{ display: "flex", flexDirection: "column", gap: 0 }}>
                            <div className="contact-card" style={{ display: "flex", flexDirection: "column", gap: 0 }}>
                                ...
                                {/* Centred as a column rather than with text-align:
                                    SocialLinkList is itself a flex container, so it
                                    would stay full-width and keep its icons left.
                                    Column + align-items shrinks both the label and
                                    the icon row to their content and centres them,
                                    and leaves the footer's left-aligned copy alone. */}
                                <div style={{ marginTop: 20, paddingTop: 18, borderTop: "1px solid var(--border)", display: "flex", flexDirection: "column", alignItems: "center" }}>
